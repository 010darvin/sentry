...
The componen- based grouping system produces a tree of nodes (referred to
as components) to produce the hash.  These are defined in
...
used, or why it might have been modified.  Additionally a component can carry `values`
